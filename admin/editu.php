...
<body>
	...
	<div id="content">
		<div class="inn">
			...
			<form ENCTYPE="multipart/form-data" action="editu_action.php" method="POST" autocomplete="off">
				<table>
					<tr>
						<td class="valign"><label for="title">Användarnamn:</label></td>
						<td><input type="text" maxlength="30" name="eduname" value="<?php echo $_REQUEST['uname']; ?>"></td>
					</tr>
					<tr>
						<td class="valign"><label for="title">Lösenord:</label></td>
						<td><input type="password" maxlength="30" name="edpwd" value="<?php echo $_REQUEST['pwd']; ?>"><br><br></td>
					</tr>
					<tr>
						<td class="valign"></td>
