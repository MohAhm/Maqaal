...
<body>
	...
	<div id="content">
		<div class="inn">
			...
			<form ENCTYPE="multipart/form-data" action="editn_action.php" method="POST" autocomplete="off">
				<table>
					<tr>
						<td class="valign"><label for="title">Namn:</label></td>
						<td><input type="text" maxlength="30" name="edname" value="<?php echo $_REQUEST['name']; ?>"></td>
					</tr>
					<tr>
						<td class="valign"><label for="title">Title:</label></td>
						<td><input type="text" maxlength="30" name="edtitle" value="<?php echo $_REQUEST['title']; ?>"><br><br></td>
					</tr>
					<tr>
						<td class="valign"></td>
